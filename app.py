...
# Streamlit -
st.markdown("<h1 style='text-align: center;'>Code Reviewer</h1>", unsafe_allow_html=True)
...
if user_code:
    ...
    review_prompt += "Check for the best practices, optimizations, and potential issues/errorss.."
